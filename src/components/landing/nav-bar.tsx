...
export function Navbar() {
	...
	return (
		<header className='sticky bg-primary/15 rounded-xl py-2 px-3 h-14 z-10 flex transition-colors items-center justify-between backdrop-blur-md xl:w-[926px] lg:w-[820px] md:w-[658px] sm:w-[450px] w-full mt-5'>
			<Capybara />
